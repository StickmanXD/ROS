...
void odomCallback(const nav_msgs::Odometry& msg) {
	...
	velocity.twist.twist.linear.x = delta_pos.pose.pose.position.x / odom_frequency;
	velocity.twist.twist.linear.y = delta_pos.pose.pose.position.y / odom_frequency;
